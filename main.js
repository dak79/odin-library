const libraryApp = (() => {
    ...
    const DOMmanipulation = (() => {
        const renderNewBook = () => {
            ...
            const readLabel = helper.createPlusTextContent(
                'label',
                'Not read Yet:'
            )
        ...
        const renderLibrary = (myLibrary) => {
            ...
            for (let item of Object.values(myLibrary)) {
                item.forEach((book, index) => {
                    ...
                    const author = helper.createPlusTextContent(
                        'p',
                        book.author
                    )
                    ...
                    const pages = helper.createPlusTextContent(
                        'span',
                        `Pages: ${book.pages}`
                    )
                    const readLabel = helper.createPlusTextContent(
                    ...
                    const btnDelete = helper.createPlusTextContent(
                        'button',
                        'Delete'
                    )
